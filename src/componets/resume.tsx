      ...
      <main className='main'>
                ...
                >
                  ...
                  <g mask='url(#mask0)'>
                    ...
                    <image
                      ...
                      x={12}
                      y={18}
                      href='https://dev.dakidarts.com/wixa/assets/img/asset.png'
                    />
                  </g>
                </svg>
              </div>
              <div className='home_data'>
                <h1 className='home_title'>Hi, I am Wixa</h1>
        ...
        <section className='about section' id='about'>
          ...
          <div className='about_container container grid'>
            <img
              src='https://dev.dakidarts.com/wixa/assets/img/asset.jpg'
              alt=''
              className='about_img'
            />
            <div className='about_data'>
              ...
              <div className='about_buttons'>
                <a
                  download=''
                  href='https://dev.dakidarts.com/wixa/assets/file/my-cv.pdf'
          ...
          <div className='portfolio_container container swiper-container'>
            <div className='swiper-wrapper'>
              ...
              <div className='portfolio_content grid swiper-slide'>
                <img
                  src='https://dev.dakidarts.com/wixa/assets/img/portfolio1.jpg'
                  alt=''
              ...
              <div className='portfolio_content grid swiper-slide'>
                <img
                  src='https://dev.dakidarts.com/wixa/assets/img/portfolio2.jpg'
                  alt=''
                  className='portfolio_img'
                />
              ...
              <div className='portfolio_content grid swiper-slide'>
                <img
                  src='https://dev.dakidarts.com/wixa/assets/img/portfolio5.jpg'
                  alt=''
                  className='portfolio_img'
                />
              ...
              <div className='portfolio_content grid swiper-slide'>
                <img
                  src='https://dev.dakidarts.com/wixa/assets/img/portfolio3.jpg'
                  alt=''
                  className='portfolio_img'
                />
          ...
          <div className='project_bg'>
            <div className='project_container container grid'>
              <div className='project'>
                <h2 className='project_title'>You got a new project?</h2>
                ...
                >
                  Contact Me{" "}
                  <i className='uil uil-location-arrow project_icon button_icon'></i>
                </a>
              </div>
              <img
                src='https://dev.dakidarts.com/wixa/assets/img/asset2.png'
                alt=''
            ...
            <div className='swiper-wrapper'>
              ...
              <div className='testimonial_content swiper-slide'>
                <div className='testimonial_data'>
                  <div className='testimonial_header'>
                    <img
                      src='https://dev.dakidarts.com/wixa/assets/img/testimonial1.jpg'
                      alt=''
              ...
              <div className='testimonial_content swiper-slide'>
                <div className='testimonial_data'>
                  <div className='testimonial_header'>
                    <img
                      src='https://dev.dakidarts.com/wixa/assets/img/testimonial2.jpg'
                      alt=''
                      className='testimonial_img'
                    />
                    <div>
              ...
              <div className='testimonial_content swiper-slide'>
                <div className='testimonial_data'>
                  <div className='testimonial_header'>
                    <img
                      src='https://dev.dakidarts.com/wixa/assets/img/testimonial3.jpg'
                      alt=''
                      className='testimonial_img'
                    />
                    <div>
            ...
            <div>
              ...
              <div className='contact_info'>
                ...
                <div>
                  ...
                  <span className='contact_subtitle'>wixa@email</span>
                </div>
              </div>
              <div className='contact_info'>
